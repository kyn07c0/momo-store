...
buckets = {
  terraform_state = "<имя_бакета>"
  app_sources = "<имя_бакета>"
}
```
...
1) В Yandex Object Storage cоздайте бакет для хранения состояния terraform и ресурсов приложений кластера.
